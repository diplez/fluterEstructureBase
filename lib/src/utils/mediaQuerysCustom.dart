...
class MediaQueryCustom{
  ...
  /**
   * Obtiene el tamaño total de pantalla en vertical
   */
  double verticalHeightScreem(){
    if(sizeScreenPhone.height>sizeScreenPhone.width){
      return sizeScreenPhone.height;
    }
    return sizeScreenPhone.width;
  }
